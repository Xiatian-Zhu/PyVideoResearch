...
args = [
    ...
    '--data', '/home/SERILOCAL/x.chang/Datasets/Kinetics400/train',
    '--valdata', '/home/SERILOCAL/x.chang/Datasets/Kinetics400/val',
    '--train-file', '/home/SERILOCAL/x.chang/Datasets/Kinetics400/kinetics_train/kinetics_train.csv',
    '--val-file', '/home/SERILOCAL/x.chang/Datasets/Kinetics400/kinetics_val/kinetics_val.csv',
    '--pretrained',
    '--nclass', '400',
