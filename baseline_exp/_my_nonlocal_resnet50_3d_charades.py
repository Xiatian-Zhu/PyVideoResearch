...
args = [
    ...
    '--val-size', '0.2',
    '--cache-dir', '/home/nfs/xiatian.zhu/caches/Action_Recognition/Charades',
    '--data', '/home/nfs/x.chang/Datasets/Charades/Charades/Charades_v1_rgb/',
    '--train-file', '/home/nfs/x.chang/Datasets/Charades/Charades/vu17_charades/Charades_v1_train.csv',
    '--val-file', '/home/nfs/x.chang/Datasets/Charades/Charades/vu17_charades/Charades_v1_validation.csv',
    '--pretrained',
    '--resume', '/home/SERILOCAL/xiatian.zhu/caches/Action_Recognition/Charades/' + name + '/model.pth.tar' +
                ';/home/SERILOCAL/xiatian.zhu/caches/Action_Recognition/Charades/nlresnet50/model_best.pth.tar',
    '--workers', '8',
